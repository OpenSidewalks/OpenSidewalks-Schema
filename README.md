...
| 0.3 | 2025-06-30 | [GitHub](https://github.com/OpenSidewalks/OpenSidewalks-Schema) | - Add [Custom Point](#custom-point)<br>- Add [Custom Line](#custom-line)<br>- Add [Custom Polygon](#custom-polygon)<br>- Add [Tree](#tree) to [Points](#points)<br>- Add [Tree Line](#tree-line) to [Lines](#lines)<br>- Add [Wood](#wood) to [Polygons](#polygons)<br>- Update the documentation to improve clarity with regards to [Adjacent Entities](#adjacent-entities) (formerly called "Extensions") |
