...
| 0.3 | 2025-06-30 | [GitHub](https://github.com/OpenSidewalks/OpenSidewalks-Schema) | - Add [Custom Points](#points-c)<br>- Add [Custom Lines](#lines-c)<br>- Add [Custom Polygons](#polygons-c)<br>- Add [Tree](#tree) to [Points](#points)<br>- Add [Tree Row](#tree-row) to [Lines](#lines)<br>- Add [Wood](#wood) to [Polygons](#polygons)<br>- Update documentation to improve clarity with regards to [Adjacent Entities](#adjacent-entities) (formerly called "Extensions") |
